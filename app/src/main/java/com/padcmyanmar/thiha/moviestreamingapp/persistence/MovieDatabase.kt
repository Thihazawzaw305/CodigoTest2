package com.padcmyanmar.thiha.moviestreamingapp.persistence
...
import com.padcmyanmar.thiha.moviestreamingapp.persistence.daos.MovieDao

@Database(entities = [MovieVO::class], version = 6, exportSchema = false)
